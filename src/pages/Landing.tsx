          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="rounded-xl overflow-hidden border border-destructive/30 bg-card shadow-lg">
              ...
              <div className="p-6">
                ...
                <div className="bg-background rounded-lg border border-border/50 p-4 mb-4 min-h-[180px]">
            ...
            <div className="rounded-xl overflow-hidden border border-primary/30 bg-card shadow-lg">
              ...
              <div className="p-6">
                <div className="bg-muted/50 rounded-lg border border-border/50 p-4 mb-4 min-h-[180px]">
